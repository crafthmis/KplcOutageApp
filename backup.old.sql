...
SELECT pg_catalog.setval('public.tbl_campaign_cmp_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.tbl_outage_area_oct_id_seq', 17, true);
...
SELECT pg_catalog.setval('public.tbl_outage_sms_ots_id_seq', 6, true);
