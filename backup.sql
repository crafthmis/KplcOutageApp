...
CREATE PROCEDURE public.insertareadata(IN areadata jsonb)
    LANGUAGE plpgsql
    AS $$
DECLARE
    record jsonb;
...
ALTER PROCEDURE public.insertareadata(IN areadata jsonb) OWNER TO postgres;

--
-- Name: updatearealocation(integer, double precision, double precision); Type: PROCEDURE; Schema: public; Owner: postgres
--

CREATE PROCEDURE public.updatearealocation(IN p_area_id integer, IN p_lat double precision, IN p_long double precision)
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER PROCEDURE public.updatearealocation(IN p_area_id integer, IN p_lat double precision, IN p_long double precision) OWNER TO postgres;
...
--
-- Name: tbl_campaign; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.tbl_campaign (
    ...
    recv_status integer DEFAULT 0,
    date_created timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    last_update timestamp without time zone
);


ALTER TABLE public.tbl_campaign OWNER TO postgres;

--
-- Name: tbl_campaign_cmp_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.tbl_campaign_cmp_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    MAXVALUE 2147483647
...
ALTER TABLE public.tbl_campaign_cmp_id_seq OWNER TO postgres;

--
-- Name: tbl_campaign_cmp_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.tbl_campaign_cmp_id_seq OWNED BY public.tbl_campaign.cmp_id;
...
--
-- Name: tbl_outage; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.tbl_outage (
    ots_id integer NOT NULL,
    message character varying(4000) NOT NULL,
    outage_date date NOT NULL,
    sent_status character varying(4000) DEFAULT 0,
    date_created timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    last_update timestamp without time zone
);


ALTER TABLE public.tbl_outage OWNER TO postgres;

--
-- Name: tbl_outage_area; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.tbl_outage_area OWNER TO postgres;

--
-- Name: tbl_outage_area_oct_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.tbl_outage_area_oct_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    MAXVALUE 2147483647
...
ALTER TABLE public.tbl_outage_area_oct_id_seq OWNER TO postgres;

--
-- Name: tbl_outage_area_oct_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.tbl_outage_area_oct_id_seq OWNED BY public.tbl_outage_area.oct_id;


--
-- Name: tbl_outage_message; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.tbl_outage_message (
...
ALTER TABLE public.tbl_outage_message OWNER TO postgres;

--
-- Name: tbl_outage_message_otm_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.tbl_outage_message_otm_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.tbl_outage_message_otm_id_seq OWNER TO postgres;

--
-- Name: tbl_outage_message_otm_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.tbl_outage_message_otm_id_seq OWNED BY public.tbl_outage_message.otm_id;


--
-- Name: tbl_outage_sms_ots_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.tbl_outage_sms_ots_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    MAXVALUE 2147483647
...
ALTER TABLE public.tbl_outage_sms_ots_id_seq OWNER TO postgres;

--
-- Name: tbl_outage_sms_ots_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.tbl_outage_sms_ots_id_seq OWNED BY public.tbl_outage.ots_id;
...
--
-- Name: tbl_subscription; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.tbl_subscription OWNER TO postgres;

--
-- Name: tbl_subscription_sub_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.tbl_subscription_sub_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.tbl_subscription_sub_id_seq OWNER TO postgres;

--
-- Name: tbl_subscription_sub_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.tbl_subscription_sub_id_seq OWNED BY public.tbl_subscription.sub_id;
...
--
-- Name: tbl_campaign cmp_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tbl_campaign ALTER COLUMN cmp_id SET DEFAULT nextval('public.tbl_campaign_cmp_id_seq'::regclass);
...
--
-- Name: tbl_outage ots_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tbl_outage ALTER COLUMN ots_id SET DEFAULT nextval('public.tbl_outage_sms_ots_id_seq'::regclass);


--
-- Name: tbl_outage_area oct_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tbl_outage_area ALTER COLUMN oct_id SET DEFAULT nextval('public.tbl_outage_area_oct_id_seq'::regclass);


--
-- Name: tbl_outage_message otm_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tbl_outage_message ALTER COLUMN otm_id SET DEFAULT nextval('public.tbl_outage_message_otm_id_seq'::regclass);
...
--
-- Name: tbl_subscription sub_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tbl_subscription ALTER COLUMN sub_id SET DEFAULT nextval('public.tbl_subscription_sub_id_seq'::regclass);
...
350-public.tbl_subscription.sql	eae95448744b83d24cdf1e70db04f16381ca5ef54461afbfc4df463bfa4f73ad	2024-08-02 15:05:32.907592
350-public.tbl_user_subscription.sql	1acc9556325becdf3e097f1732673b64fe11102b90a37bbdaa3c968fdbd63773	2024-08-02 15:05:32.907592
...
--
-- Data for Name: tbl_campaign; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.tbl_campaign (cmp_id, ots_id, msisdn, message, sent_status, ack_status, recv_status, date_created, last_update) FROM stdin;
\.
...
COPY public.tbl_contact (cnt_id, area_id, sub_id, msisdn, first_name, last_name, username, password, email, auth_token, date_created, last_update) FROM stdin;
...
--
-- Data for Name: tbl_outage; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.tbl_outage (ots_id, message, outage_date, sent_status, date_created, last_update) FROM stdin;
2	Scheduled maintenance	2024-08-21	Pending	2024-08-21 21:03:35.673339	2024-08-21 21:03:35.673339
3	Scheduled maintenance	2024-08-21	Pending	2024-08-21 21:07:21.897777	2024-08-21 21:07:21.897777
4	Scheduled maintenance	2024-08-21	Pending	2024-08-21 21:29:56.249458	2024-08-21 21:29:56.249458
5	Scheduled maintenance	2024-08-21	Pending	2024-08-21 21:30:03.721623	2024-08-21 21:30:03.721623
\.


--
-- Data for Name: tbl_outage_area; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.tbl_outage_area (oct_id, ots_id, area_id) FROM stdin;
10	4	1
11	4	2
12	4	3
13	5	1
...
--
-- Data for Name: tbl_outage_message; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.tbl_outage_message (otm_id, ots_id, user_id, phone, message, date_created, last_update) FROM stdin;
\.
...
--
-- Data for Name: tbl_subscription; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.tbl_subscription (sub_id, name, description, amount, date_created, last_update) FROM stdin;
1	On Demand	On Demand	0	2024-08-11 23:24:06.708823+03	2024-08-11 23:28:17.133648+03
2	Monthly	Monthly	50	2024-08-11 23:24:06.708823+03	2024-08-11 23:28:47.155955+03
3	Yearly	Yearly	250	2024-08-11 23:24:06.708823+03	2024-08-11 23:29:10.890015+03
\.
...
ATUid_1732537cec9b53159121e0ce258e630a	+254714812921	[\n  {\n    "SubID": 1,\n    "Name": "On Demand",\n    "Description": "On Demand",\n    "Amount": 0\n  },\n  {\n    "SubID": 2,\n    "Name": "Monthly",\n    "Description": "Monthly",\n    "Amount": 50\n  },\n  {\n    "SubID": 3,\n    "Name": "Yearly",\n    "Description": "Yearly",\n    "Amount": 250\n  }\n]	[\n  {\n    "RegID": 1,\n    "Name": "Coast",\n    "Counties": null\n  },\n  {\n    "RegID": 2,\n    "Name": "Nairobi",\n    "Counties": null\n  },\n  {\n    "RegID": 3,\n    "Name": "North Eastern",\n    "Counties": null\n  },\n  {\n    "RegID": 4,\n    "Name": "Eastern",\n    "Counties": null\n  },\n  {\n    "RegID": 5,\n    "Name": "Western",\n    "Counties": null\n  },\n  {\n    "RegID": 6,\n    "Name": "South Rift",\n    "Counties": null\n  },\n  {\n    "RegID": 7,\n    "Name": "Central",\n    "Counties": null\n  },\n  {\n    "RegID": 8,\n    "Name": "North Rift",\n    "Counties": null\n  },\n  {\n    "RegID": 9,\n    "Name": "Nyanza",\n    "Counties": null\n  }\n]	[\n  {\n    "CtyID": 10,\n    "Code": "18",\n    "Name": "Nyandarua",\n    "Region": null,\n    "Constituencies": null\n  },\n  {\n    "CtyID": 16,\n    "Code": "21",\n    "Name": "Muranga",\n    "Region": null,\n    "Constituencies": null\n  },\n  {\n    "CtyID": 18,\n    "Code": "22",\n    "Name": "Kiambu",\n    "Region": null,\n    "Constituencies": null\n  },\n  {\n    "CtyID": 30,\n    "Code": "19",\n    "Name": "Nyeri",\n    "Region": null,\n    "Constituencies": null\n  },\n  {\n    "CtyID": 33,\n    "Code": "20",\n    "Name": "Kirinyaga",\n    "Region": null,\n    "Constituencies": null\n  }\n]	[\n  {\n    "CstID": 13,\n    "Name": "Kinangop",\n    "Areas": null,\n    "County": null\n  },\n  {\n    "CstID": 98,\n    "Name": "Kipipiri",\n    "Areas": null,\n    "County": null\n  },\n  {\n    "CstID": 106,\n    "Name": "Ndaragwa",\n    "Areas": null,\n    "County": null\n  },\n  {\n    "CstID": 109,\n    "Name": "Ol Jorok",\n    "Areas": null,\n    "County": null\n  },\n  {\n    "CstID": 114,\n    "Name": "Ol Kalou",\n    "Areas": null,\n    "County": null\n  }\n]	[\n  {\n    "AreaID": 36,\n    "Name": "Engineer",\n    "Lon": "",\n    "Lat": "",\n    "Constituency": null,\n    "Contacts": null\n  },\n  {\n    "AreaID": 37,\n    "Name": "Gathara",\n    "Lon": "",\n    "Lat": "",\n    "Constituency": null,\n    "Contacts": null\n  },\n  {\n    "AreaID": 38,\n    "Name": "North Kinangop",\n    "Lon": "",\n    "Lat": "",\n    "Constituency": null,\n    "Contacts": null\n  },\n  {\n    "AreaID": 39,\n    "Name": "Murungaru",\n    "Lon": "",\n    "Lat": "",\n    "Constituency": null,\n    "Contacts": null\n  },\n  {\n    "AreaID": 40,\n    "Name": "Njabini\\\\\\\\Kiburu",\n    "Lon": "",\n    "Lat": "",\n    "Constituency": null,\n    "Contacts": null\n  },\n  {\n    "AreaID": 41,\n    "Name": "Nyakio",\n    "Lon": "",\n    "Lat": "",\n    "Constituency": null,\n    "Contacts": null\n  },\n  {\n    "AreaID": 42,\n    "Name": "Githabai",\n    "Lon": "",\n    "Lat": "",\n    "Constituency": null,\n    "Contacts": null\n  },\n  {\n    "AreaID": 43,\n    "Name": "Magumu",\n    "Lon": "",\n    "Lat": "",\n    "Constituency": null,\n    "Contacts": null\n  }\n]	Yes	2024-08-23 13:18:30.761769+03	0001-01-01 02:27:16+02:27:16
ATUid_7849dc783b69c737fe9400c5b8563fe3	+254714812921	[\n  {\n    "SubID": 1,\n    "Name": "On Demand",\n    "Description": "On Demand",\n    "Amount": 0\n  },\n  {\n    "SubID": 2,\n    "Name": "Monthly",\n    "Description": "Monthly",\n    "Amount": 50\n  },\n  {\n    "SubID": 3,\n    "Name": "Yearly",\n    "Description": "Yearly",\n    "Amount": 250\n  }\n]	[\n  {\n    "RegID": 1,\n    "Name": "Coast",\n    "Counties": null\n  },\n  {\n    "RegID": 2,\n    "Name": "Nairobi",\n    "Counties": null\n  },\n  {\n    "RegID": 3,\n    "Name": "North Eastern",\n    "Counties": null\n  },\n  {\n    "RegID": 4,\n    "Name": "Eastern",\n    "Counties": null\n  },\n  {\n    "RegID": 5,\n    "Name": "Western",\n    "Counties": null\n  },\n  {\n    "RegID": 6,\n    "Name": "South Rift",\n    "Counties": null\n  },\n  {\n    "RegID": 7,\n    "Name": "Central",\n    "Counties": null\n  },\n  {\n    "RegID": 8,\n    "Name": "North Rift",\n    "Counties": null\n  },\n  {\n    "RegID": 9,\n    "Name": "Nyanza",\n    "Counties": null\n  }\n]	[\n  {\n    "CtyID": 6,\n    "Code": "11",\n    "Name": "Isiolo",\n    "Region": null,\n    "Constituencies": null\n  },\n  {\n    "CtyID": 7,\n    "Code": "12",\n    "Name": "Meru",\n    "Region": null,\n    "Constituencies": null\n  },\n  {\n    "CtyID": 26,\n    "Code": "10",\n    "Name": "Marsabit",\n    "Region": null,\n    "Constituencies": null\n  },\n  {\n    "CtyID": 27,\n    "Code": "13",\n    "Name": "Tharaka-Nithi",\n    "Region": null,\n    "Constituencies": null\n  },\n  {\n    "CtyID": 28,\n    "Code": "14",\n    "Name": "Embu",\n    "Region": null,\n    "Constituencies": null\n  },\n  {\n    "CtyID": 29,\n    "Code": "15",\n    "Name": "Kitui",\n    "Region": null,\n    "Constituencies": null\n  },\n  {\n    "CtyID": 31,\n    "Code": "17",\n    "Name": "Makueni",\n    "Region": null,\n    "Constituencies": null\n  },\n  {\n    "CtyID": 32,\n    "Code": "16",\n    "Name": "Machakos",\n    "Region": null,\n    "Constituencies": null\n  }\n]	[\n  {\n    "CstID": 9,\n    "Name": "Isiolo South",\n    "Areas": null,\n    "County": null\n  },\n  {\n    "CstID": 71,\n    "Name": "Isiolo North",\n    "Areas": null,\n    "County": null\n  }\n]	[\n  {\n    "AreaID": 296,\n    "Name": "Wabera",\n    "Lon": "",\n    "Lat": "",\n    "Constituency": null,\n    "Contacts": null\n  },\n  {\n    "AreaID": 297,\n    "Name": "Bulla Pesa",\n    "Lon": "",\n    "Lat": "",\n    "Constituency": null,\n    "Contacts": null\n  },\n  {\n    "AreaID": 298,\n    "Name": "Chari",\n    "Lon": "",\n    "Lat": "",\n    "Constituency": null,\n    "Contacts": null\n  },\n  {\n    "AreaID": 299,\n    "Name": "Cherab",\n    "Lon": "",\n    "Lat": "",\n    "Constituency": null,\n    "Contacts": null\n  },\n  {\n    "AreaID": 300,\n    "Name": "Ngare Mara",\n    "Lon": "",\n    "Lat": "",\n    "Constituency": null,\n    "Contacts": null\n  },\n  {\n    "AreaID": 301,\n    "Name": "Burat",\n    "Lon": "",\n    "Lat": "",\n    "Constituency": null,\n    "Contacts": null\n  },\n  {\n    "AreaID": 302,\n    "Name": "Oldonyiro",\n    "Lon": "",\n    "Lat": "",\n    "Constituency": null,\n    "Contacts": null\n  }\n]	Yes	2024-08-23 13:20:06.851894+03	0001-01-01 02:27:16+02:27:16
ATUid_671fc7f2fce924b963868efb8f270fe8	+254714812921	[\n  {\n    "SubID": 1,\n    "Name": "On Demand",\n    "Description": "On Demand",\n    "Amount": 0\n  },\n  {\n    "SubID": 2,\n    "Name": "Monthly",\n    "Description": "Monthly",\n    "Amount": 50\n  },\n  {\n    "SubID": 3,\n    "Name": "Yearly",\n    "Description": "Yearly",\n    "Amount": 250\n  }\n]	[\n  {\n    "RegID": 1,\n    "Name": "Coast",\n    "Counties": null\n  },\n  {\n    "RegID": 2,\n    "Name": "Nairobi",\n    "Counties": null\n  },\n  {\n    "RegID": 3,\n    "Name": "North Eastern",\n    "Counties": null\n  },\n  {\n    "RegID": 4,\n    "Name": "Eastern",\n    "Counties": null\n  },\n  {\n    "RegID": 5,\n    "Name": "Western",\n    "Counties": null\n  },\n  {\n    "RegID": 6,\n    "Name": "South Rift",\n    "Counties": null\n  },\n  {\n    "RegID": 7,\n    "Name": "Central",\n    "Counties": null\n  },\n  {\n    "RegID": 8,\n    "Name": "North Rift",\n    "Counties": null\n  },\n  {\n    "RegID": 9,\n    "Name": "Nyanza",\n    "Counties": null\n  }\n]	[\n  {\n    "CtyID": 9,\n    "Code": "33",\n    "Name": "Narok",\n    "Region": null,\n    "Constituencies": null\n  },\n  {\n    "CtyID": 38,\n    "Code": "32",\n    "Name": "Nakuru",\n    "Region": null,\n    "Constituencies": null\n  },\n  {\n    "CtyID": 40,\n    "Code": "31",\n    "Name": "Laikipia",\n    "Region": null,\n    "Constituencies": null\n  },\n  {\n    "CtyID": 41,\n    "Code": "35",\n    "Name": "Kericho",\n    "Region": null,\n    "Constituencies": null\n  },\n  {\n    "CtyID": 42,\n    "Code": "36",\n    "Name": "Bomet",\n    "Region": null,\n    "Constituencies": null\n  },\n  {\n    "CtyID": 43,\n    "Code": "34",\n    "Name": "Kajiado",\n    "Region": null,\n    "Constituencies": null\n  }\n]	[\n  {\n    "CstID": 187,\n    "Name": "Chepalungu",\n    "Areas": null,\n    "County": null\n  },\n  {\n    "CstID": 192,\n    "Name": "Bomet East",\n    "Areas": null,\n    "County": null\n  },\n  {\n    "CstID": 205,\n    "Name": "Sotik",\n    "Areas": null,\n    "County": null\n  },\n  {\n    "CstID": 210,\n    "Name": "Konoin",\n    "Areas": null,\n    "County": null\n  },\n  {\n    "CstID": 219,\n    "Name": "Bomet Central",\n    "Areas": null,\n    "County": null\n  }\n]	[\n  {\n    "AreaID": 888,\n    "Name": "Kongasis",\n    "Lon": "",\n    "Lat": "",\n    "Constituency": null,\n    "Contacts": null\n  },\n  {\n    "AreaID": 889,\n    "Name": "Nyangores",\n    "Lon": "",\n    "Lat": "",\n    "Constituency": null,\n    "Contacts": null\n  },\n  {\n    "AreaID": 890,\n    "Name": "Sigor",\n    "Lon": "",\n    "Lat": "",\n    "Constituency": null,\n    "Contacts": null\n  },\n  {\n    "AreaID": 891,\n    "Name": "Chebunyo",\n    "Lon": "",\n    "Lat": "",\n    "Constituency": null,\n    "Contacts": null\n  },\n  {\n    "AreaID": 892,\n    "Name": "Siongiroi",\n    "Lon": "",\n    "Lat": "",\n    "Constituency": null,\n    "Contacts": null\n  }\n]	Yes	2024-08-23 13:21:44.498528+03	0001-01-01 02:27:16+02:27:16
\.
...
--
-- Name: tbl_campaign_cmp_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.tbl_campaign_cmp_id_seq', 1, false);
...
--
-- Name: tbl_outage_area_oct_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.tbl_outage_area_oct_id_seq', 15, true);


--
-- Name: tbl_outage_message_otm_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.tbl_outage_message_otm_id_seq', 1, false);


--
-- Name: tbl_outage_sms_ots_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.tbl_outage_sms_ots_id_seq', 5, true);
...
--
-- Name: tbl_subscription_sub_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.tbl_subscription_sub_id_seq', 4, true);
...
--
-- Name: tbl_campaign tbl_campaign_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: tbl_outage_area tbl_outage_area_ots_id_area_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tbl_outage_area
    ADD CONSTRAINT tbl_outage_area_ots_id_area_id_key UNIQUE (ots_id, area_id);


--
-- Name: tbl_outage_area tbl_outage_area_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tbl_outage_area
    ADD CONSTRAINT tbl_outage_area_pkey PRIMARY KEY (oct_id);


--
-- Name: tbl_outage_message tbl_outage_message_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tbl_outage_message
    ADD CONSTRAINT tbl_outage_message_pkey PRIMARY KEY (otm_id);


--
-- Name: tbl_outage tbl_outage_sms_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tbl_outage
    ADD CONSTRAINT tbl_outage_sms_pkey PRIMARY KEY (ots_id);
...
--
-- Name: tbl_subscription tbl_subscription_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.tbl_subscription
    ADD CONSTRAINT tbl_subscription_pkey PRIMARY KEY (sub_id);
...
--
-- Name: tbl_outage_message_ots_id_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX tbl_outage_message_ots_id_idx ON public.tbl_outage_message USING btree (ots_id);


--
-- Name: tbl_outage_message_user_id_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX tbl_outage_message_user_id_idx ON public.tbl_outage_message USING btree (user_id);


--
-- Name: tbl_subscription_name_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX tbl_subscription_name_idx ON public.tbl_subscription USING btree (name);
